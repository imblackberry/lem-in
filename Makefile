...
SRC = lem_in.c set_farm.c check_data.c check_level_2.c new_structs.c adding.c
...
comp:
	@gcc -g $(FLAGS) $(addprefix $(SRCDIR), $(SRC)) ft_printf/libftprintf.a -I headers/lem-in.h -o debug
